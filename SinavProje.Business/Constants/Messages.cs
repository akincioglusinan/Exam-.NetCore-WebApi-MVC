namespace SinavProje.Business.Constants
{
    ...
    {
        public static string ExamAdded = "The exam is successfully added.";
        public static string ExamUpdated = "The exam is successfully updated.";
        public static string ExamDeleted = "The exam is removed.";

        public static string ExamAddError = "Error occurred while adding the exam.";
        public static string ExamDeleteError = "Error occurred while removing the exam.";
        ...
        public static string QuestionAdded = "The questions is successfully added.";
        public static string QuestionUpdated = "The questions is successfully updated.";
        public static string QuestionDeleted = "The questions is successfully deleted.";
        ...
        public static string UserAdded = "The user is successfully added.";
        public static string UserUpdated = "The user is successfully updated.";
        public static string UserDeleted = "The user is removed.";
        ...
        public static string UserRegistered = "The user is successfully registered.";
        public static string AccessTokenCreated = "Token is successfully created.";
        public static string GetArticlesError = "Error occurred while getting articles!";
        public static string QuestionLimit = "At least 1 question has to be added!";
    }
}